...
def main():
    ...
    os.makedirs(f"gin_{args.dataset.lower()}", exist_ok=True)
    ...
    best_path = f"gin_{args.dataset.lower()}/model_{args.dataset}_hidden_{args.model_size}_dropout_{args.dropout}_seed_{args.seed}.pth"
    wait = 0
    # Training loop
